...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewOriginalTitle.setText(movie.getOriginalTetle());
    ...
    private void setFavourite(){
        ...
        if (favouriteMovie == null) {
            imageViewAddToFavourite.setImageResource(R.drawable.plus);
        } else {
            imageViewAddToFavourite.setImageResource(R.drawable.minus);
        }
    }
}