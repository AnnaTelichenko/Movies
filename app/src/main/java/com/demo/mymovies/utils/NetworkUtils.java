...
public class NetworkUtils {
    ...
    private static final String BASE_URL_REVIEWS = "https://api.themoviedb.org/3/movie/{movie_id}/reviews";
    ...
    private static final String API_KEY = "9e256208342a003e82b4fe03bd82edc6";
